...
**Repository License:** The code in this repository is provided as a reference implementation for evaluation purposes only. See [LICENSE](https://github.com/zeam-labs/zeam-testnet/blob/main/LICENSE) for terms. A valid patent license from ZEAM Labs, LLC is required for any commercial or production use.
